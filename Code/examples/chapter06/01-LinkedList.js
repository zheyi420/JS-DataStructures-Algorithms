...
import LinkedList from './../../src/js/data-structures/linked-list-withtailnode.js';

const list = new LinkedList();

console.log('insert element 15');
list.insert(15, 0);
console.log('list.getEnd() => ', list.getEnd().element);
...
console.log('list.toString() => ', list.toString());
console.log('list.removeAt(4) => ', list.removeAt(4));
console.log('list.getEnd() => ', list.getEnd().element);
console.log('list.toString() => ', list.toString());
...
console.log('list.getEnd() => ', list.getEnd().element);
console.log('list.toString() => ', list.toString());
console.log('insert element 17 pos 5 => ', list.insert(17, 5));
console.log('list.getEnd() => ', list.getEnd().element);
console.log('list.toString() => ', list.toString());
